...
func TestDashboardAndMaintenanceAPI(t *testing.T) {
	...
	if page.Code != http.StatusOK || !strings.Contains(page.Body.String(), "Wikipedia Multistream MCP") || strings.Contains(page.Body.String(), "<th>Upgrade</th>") || strings.Contains(page.Body.String(), "Search-ready") || !strings.Contains(page.Body.String(), "Total pages") || !strings.Contains(page.Body.String(), "bi-trash3") || !strings.Contains(page.Body.String(), `id="onlineWikisModal"`) || !strings.Contains(page.Body.String(), "limit=-1") || !strings.Contains(page.Body.String(), "All Languages") || !strings.Contains(page.Body.String(), "hideInstalled") || !strings.Contains(page.Body.String(), "filteredAvailable") || !strings.Contains(page.Body.String(), "dump index") || !strings.Contains(page.Body.String(), "storage-column") {
