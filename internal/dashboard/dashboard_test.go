...
func TestDashboardAndMaintenanceAPI(t *testing.T) {
	...
	if page.Code != http.StatusOK || !strings.Contains(page.Body.String(), "Knowledge MCP") || !strings.Contains(page.Body.String(), `href="https://github.com/lkarlslund/knowledge-mcp"`) || !strings.Contains(page.Body.String(), `aria-label="View Knowledge MCP on GitHub"`) || strings.Contains(page.Body.String(), "<th>Upgrade</th>") || !strings.Contains(page.Body.String(), "Total documents") || !strings.Contains(page.Body.String(), "bi-trash3") || !strings.Contains(page.Body.String(), `id="onlineDatasetsModal"`) || !strings.Contains(page.Body.String(), `id="settingsModal"`) || !strings.Contains(page.Body.String(), "indexing_parallelism") || !strings.Contains(page.Body.String(), "Provider catalogs") || !strings.Contains(page.Body.String(), "Refresh now") || strings.Contains(page.Body.String(), "limit=-1") || !strings.Contains(page.Body.String(), "limit:'40'") || !strings.Contains(page.Body.String(), "availableHasMore") || !strings.Contains(page.Body.String(), "catalog-modal") || !strings.Contains(page.Body.String(), "catalog-table") || !strings.Contains(page.Body.String(), "overflow-x: clip") || strings.Contains(page.Body.String(), "modal-xl") || !strings.Contains(page.Body.String(), "All Languages") || !strings.Contains(page.Body.String(), "hideInstalled") || !strings.Contains(page.Body.String(), "provider metadata") || !strings.Contains(page.Body.String(), "storage-column") || !strings.Contains(page.Body.String(), "hydrated: false") || !strings.Contains(page.Body.String(), "Loading local state") || strings.Contains(page.Body.String(), "await this.loadUpgrades()") {
